            ...
            children: [
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  ...
                  image: DecorationImage(image: AssetImage('assets/taskImages/child2.jpg'), fit: BoxFit.cover)
                ),
              ),
              const SizedBox(height: 16.0),
              const Text(
                  "Цель – создать пространство, куда вы сможете возвращаться для встречи с внутренним ребенком и наполнения радостью и теплом.",
              ...
              const SizedBox(height: 20.0),
              const Text(
                "•	Как вы себя чувствуете, когда открываете коробку?",
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
                  fontWeight: FontWeight.w800,
              ...
              const SizedBox(height: 8.0),
              const Text(
                "•	Какие эмоции вызывает взаимодействие с её содержимым?",
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
                  fontWeight: FontWeight.w800,
              ...
              const SizedBox(height: 8.0),
              const Text(
                "•	Что ещё могло бы порадовать вашего внутреннего ребенка?",
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
                  fontWeight: FontWeight.w800,
